...
@section('content')
    ...
    <section class="log-form">
        <form method="post" action="{{url('login/post')}}">
            @csrf
            <input type="text" name="user" class="log-ten" placeholder="Tên đăng nhập" spellcheck="false"
                autocomplete="off" />
            <input type="password" name="pass" class="log-ten" placeholder="Mật khẩu" spellcheck="false"
                autocomplete="off" />
            <input type="submit" name="login" value="Đăng nhập" class="log-sub" />
        </form>
    </section>
@endsection
